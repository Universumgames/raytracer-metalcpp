...
namespace RayTracing {
    ...
    public:
        ...
        MeshedRayTraceableObject(const RGBf &color, float specularIntensity, const Vec3 &position, const Vec3 &rotation,
                                 std::string fileName)
            : RayTraceableObject(color, specularIntensity, position, {1, 1, 1}, rotation),
